...
class MineTabeHeadView: UIView {
    ...
    override func layoutSubviews() {
        ...
        let subViewW = frame.width / 3
        orderView.frame = CGRect(x: 0, y: 0, width: subViewW, height: frame.height)
        couponView.frame = CGRect(x: subViewW, y: 0, width: subViewW, height: frame.height)
        messageView.frame = CGRect(x: subViewW * 2, y: 0, width: subViewW, height: frame.height)
        couponNumber?.frame = CGRect(x: subViewW * 1.56, y: 12, width: 15, height: 15)
        line1.frame = CGRect(x: subViewW - 0.5, y: frame.height * 0.2, width: 1, height: frame.height * 0.6)
        line2.frame = CGRect(x: subViewW * 2 - 0.5, y: frame.height * 0.2, width: 1, height: frame.height * 0.5)
    ...
    private func buildUI(){
        ...
        couponNumber?.setBackgroundImage(UIImage(named: "redCycle"), for: UIControl.State.normal)
...
class MineOrderView: UIView {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        btn = MineUpImageDownText(frame: .zero, title: "我的订单", imageName: "v2_my_order_icon")
        addSubview(btn)
    }
    ...
    override func layoutSubviews() {
        super.layoutSubviews()
        btn.frame = CGRect(x: 10, y: 10, width: frame.width - 20, height: frame.height - 20)
    }
}
...
class MineCouponView: UIView {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        btn = MineUpImageDownText(frame: .zero, title: "优惠劵", imageName: "v2_my_coupon_icon")
        addSubview(btn)
    }
...
class MineMessageView: UIView {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        btn = MineUpImageDownText(frame: .zero, title: "我的消息", imageName: "v2_my_message_icon")
        addSubview(btn)
    }
...
class MineUpImageDownText: UpImageDownTextButton {
    ...
    init(frame: CGRect, title: String, imageName: String) {
        ...
        setTitleColor(UIColor(r: 80, g: 80, b: 80), for: .normal)
