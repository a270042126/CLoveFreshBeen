...
class CostDetailView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        buildLabel(labelFrame: CGRect(x: 15, y: 100, width: 100, height: 20), text: "优惠劵", font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.left)
